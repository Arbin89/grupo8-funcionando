  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4">
        <h1 className="text-5xl font-extrabold text-texthomecolor mb-4 animate-fade-in">
          Bienvenido a SIGER
        </h1>
        ...
        <div className="flex gap-4 animate-fade-in" style={{ animationDelay: "0.2s" }}>
          <Link
            to="/reservar"
            className="bg-bgreservabtn text-background px-6 py-2.5 rounded-full font-medium hover:opacity-90 transition text-sm"
          >
            Hacer Reserva
          </Link>
          <Link
